  ...
  return (
    <Layout className="document-container">
      ...
      <div className="document-content">
        ...
        <p>
          Thank you for attending my session at THAT Conference. Please{' '}
          <a href="https://forms.gle/8hFjvCAht6iwE2FQ9">
            share your contact information
          </a>{' '}
          with me so I can connect with you after the conference.
        </p>
      </div>
    </Layout>
  )
